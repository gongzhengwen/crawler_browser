...
const document = catvm.proxy(class document {})
const location = catvm.proxy(class location {})
const navigator = catvm.proxy(class navigator {})
const history = catvm.proxy(class history {})
const Request = catvm.proxy(class Request {})
const localStorage = catvm.proxy(class localStorage {})
const sessionStorage = catvm.proxy(class sessionStorage {})

location.href = 'https://www.douyin.com/search/%E5%A4%A7%E9%9D%92%E9%9D%92?aid=dd67740d-6fee-4342-8a00-8d3ba15d460f&source=search_history&type=user'
location.protocol = 'https:'
navigator.userAgent = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36'

document.cookie = ''
document.referrer = 'https://www.douyin.com/search/function%20()%20%7B%20%5Bnative%20code%5D%20%7D?source=switch_tab&type=user'

// 补一个 document.createElement("div") 环境
document.createElement = 'createElement() { [native code] }'
document.createEvent = 'createEvent() { [native code] }'
